...
auto battery_monitor::init(ECTS *ects) -> void {
    ...
    data = {
            ...
            ects->m_rosIf.create_publisher<battery_state>(battery_state_topic),
            ects->m_rosIf.create_publisher<charge_percentage>(percentage_topic),
            ects->m_rosIf.create_publisher<estimated_runtime>(runtime_topic),
            ects->m_rosIf.create_publisher<warning>(warning_topic),
    };
